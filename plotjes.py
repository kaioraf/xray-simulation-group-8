...
#    averagewattages_lst=[pixel_average(str(volt)+"kV\\"+str(watt)+"W", pixelx, pixely) for watt in wattages]
...
#      variancevoltages_lst=[pixel_variance(str(volt)+"kV\\"+str(watt)+"W", pixelx, pixely) for volt in voltages]
...
for volt in voltages:
    variancewattages_lst=[pixel_variance(str(volt)+"kV\\"+str(watt)+"W", pixelx, pixely) for watt in wattages]
